...
RailStrap is a Front-end / Back-end template using HTML5 Boilerplate, Twitter Bootstrap and Ruby on Rails (3.2.x) with an powerful authentication system for build ruby on rails websites in seconds.
